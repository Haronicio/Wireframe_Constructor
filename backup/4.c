/*j'ai résolu l'erreur du siècle ! enfaite les emplacements en mémoires alloué de x y et z se chauvauchait laissant place a des valeurs trop grandes ,pour résoudre ce problème il faut faire un clear alloxation d'une grandeur plus grandes que le future replace allocation
il est donc urgent de trouver une parade comme crée les pointeurs dans la fonction input et les transféré hors celle ci*/  
/*                                _      
...
int main(int argc, char *argv[])
{
	...
	y = calloc(100,sizeof(float));
	z = calloc(100,sizeof(float));
	int Hauteur = 600;
